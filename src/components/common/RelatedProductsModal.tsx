    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
            ...
            <div className="relative w-full max-w-[800px] bg-white dark:bg-slate-900 rounded-xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-800 animate-in zoom-in-95 duration-200">
                ...
                <div className="relative flex flex-col items-center text-center pt-10 pb-6 px-8 bg-slate-50 dark:bg-slate-900">
                    <button
                        onClick={onClose}
                    ...
                    <div className="w-32 h-32 mb-6 bg-green-500/10 rounded-full flex items-center justify-center relative">
                        <div className="absolute inset-0 bg-green-500/20 rounded-full scale-110 blur-sm"></div>
                        <CheckCircle className="text-green-500 w-16 h-16 relative z-10" />

                        {/* Fun decorative dots */}
                        <div className="absolute -top-2 -right-2 w-4 h-4 bg-green-500 rounded-full"></div>
                        <div className="absolute top-1/2 -left-6 w-3 h-3 bg-green-500/40 rounded-full"></div>
                        <div className="absolute -bottom-2 left-4 w-5 h-5 bg-green-500/60 rounded-full"></div>
                    </div>

                    <h2 className="text-3xl font-bold tracking-tight mb-2 text-slate-900 dark:text-white">Tuyệt vời! Lựa chọn rất chuẩn!</h2>
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mt-8 w-full">
                        <button
                            onClick={onClose}
                            className="px-8 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 font-semibold rounded-full hover:bg-slate-50 dark:hover:bg-slate-700 transition-all flex items-center gap-2"
                        >
                        ...
                        <Link
                            href="/cart"
                            className="px-8 py-3 bg-green-500 text-white font-bold rounded-full shadow-lg shadow-green-500/20 hover:bg-green-600 transition-all flex items-center gap-2"
                            onClick={onClose}
                        >
                            Vào giỏ hàng
                ...
                {/* Cross-sell Section */}
                <div className="bg-white dark:bg-slate-800/50 p-8 border-t border-slate-100 dark:border-slate-800">
