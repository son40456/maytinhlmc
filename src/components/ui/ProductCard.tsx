            ...
            <div className="flex flex-1 flex-col p-3">
                ...
                <div className="mt-auto pt-3 flex items-center justify-between gap-2">
                    ...
                    <button
                        ...
                        className="w-10 h-10 rounded-xl bg-[#0f172a] text-white hover:bg-blue-600 focus:outline-none transition-colors flex items-center justify-center shrink-0 shadow-md shadow-slate-900/20"
                        title="Thêm vào giỏ"
                    >
