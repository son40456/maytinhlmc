        ...
        <div className={`space-y-2 ${isMobile ? '' : ''}`}>
            ...
            {brandFilter && (
                <div className={isMobile ? '' : 'flex flex-col md:flex-row md:items-start gap-3'}>
                    <span className="text-[18px] font-semibold text-gray-900 w-[165px] shrink-0 whitespace-nowrap block mb-2 md:mb-0 md:pt-1">Thương hiệu:</span>
            ...
            {dynamicPriceFilter && (
                <div className={isMobile ? '' : 'flex flex-col md:flex-row md:items-start gap-3'}>
                    <span className="text-[18px] font-semibold text-gray-900 w-[165px] shrink-0 whitespace-nowrap block mb-2 md:mb-0 md:pt-1">Khoảng giá:</span>
            ...
            {otherFilters.length > 0 && (
                <div className={isMobile ? 'space-y-3' : 'flex flex-col md:flex-row md:items-start gap-3 pt-3 border-t border-gray-50'}>
                    {isMobile ? (
                        ...
                        <>
                            <span className="text-[18px] font-semibold text-gray-900 w-[165px] shrink-0 whitespace-nowrap block mb-2 md:mb-0 md:pt-2">Chọn theo tiêu chí:</span>
            ...
            <div className={isMobile ? '' : 'flex flex-col md:flex-row md:items-start gap-3 pt-3 border-t border-gray-50'}>
                <span className="text-[18px] font-semibold text-gray-900 w-[165px] shrink-0 whitespace-nowrap block mb-2 md:mb-0 md:pt-1">Sắp xếp:</span>
