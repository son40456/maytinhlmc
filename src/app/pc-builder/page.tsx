...
export default function BuildPcPage() {
    ...
    const PREBUILT_TEMPLATES = [
        { name: "PC Văn Phòng", priceHint: "Cơ bản", icon: "💻", description: "Lướt web, Office mượt mà", onClick: () => alert("Tính năng cấu hình sẵn đang được cập nhật.") }, //onClick: () => { window.location.search = "?mainboard=123&cpu=456&ram=789";
